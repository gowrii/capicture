...
√ Error message & Validation for empty image submissions

√ other users can view another user's board content

√ Timer countdown to the start_time of every Game on Index page - Codecademy javascript code used

√ Create Sample Game for Friday's Demo

S: Game Theme Model (categories)s

* Deploy

* add AJAX requests to Board show page's forms
